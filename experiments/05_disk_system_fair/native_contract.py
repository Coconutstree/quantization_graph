...
METHOD_SPECS: tuple[MethodSpec, ...] = (
    ...
    MethodSpec("05b", "PQ-DiskANN-Disk", "02_diskann_fair", "DiskANN FixedChunkPQTable 4-bit", ("hybrid_disk",), "algorithm_preserving_disk_port"),
    MethodSpec("05b", "SQ-DiskANN-Disk", "02_diskann_fair", "DiskANN ScalarQuantizer<4>", ("hybrid_disk",), "algorithm_preserving_disk_port"),
