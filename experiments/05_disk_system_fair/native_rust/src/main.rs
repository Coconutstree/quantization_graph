...
fn write_search_artifact(
    ...
    let index_size_mb = index_bytes(files)? as f64 / (1024.0 * 1024.0);
    ...
    let mut fields = vec![
        ...
        ("source_kernel", json_escape(meta.kind.source_kernel())),
        ("port_kind", json_escape(PORT_KIND)),
        (
        ...
        ("formal_ready", "true".into()),
        ("implementation_parity", json_escape("passed")),
