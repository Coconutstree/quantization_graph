...
AG_GRAPH="results/memory_environment/dataset_artifacts/agnews/indexes/02_diskann_fair/shared_graph/diskann_fp32_R64_Lbuild400_alpha1.2_seed${SEED}.graph.bin"
