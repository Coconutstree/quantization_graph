...
bash Ours/experiments/run_gist_query_codec_search_sweep.sh
...
# 5. 确定性校验与聚合
Ours/experiments/analyze_gist_query_codec_search_sweep.py \\
...
# 6. 生成零依赖 SVG 曲线
Ours/experiments/plot_gist_query_codec_search_sweep.py \\
...
# 7. 生成 Markdown 报告
Ours/experiments/build_gist_query_codec_search_markdown.py \\
...
- Sweep 与 NUMA/CPU 固定：[`run_gist_query_codec_search_sweep.sh`](../../Ours/experiments/run_gist_query_codec_search_sweep.sh)
- 两轮校验和聚合：[`analyze_gist_query_codec_search_sweep.py`](../../Ours/experiments/analyze_gist_query_codec_search_sweep.py)
- SVG 绘图：[`plot_gist_query_codec_search_sweep.py`](../../Ours/experiments/plot_gist_query_codec_search_sweep.py)
- Markdown 生成：[`build_gist_query_codec_search_markdown.py`](../../Ours/experiments/build_gist_query_codec_search_markdown.py)
