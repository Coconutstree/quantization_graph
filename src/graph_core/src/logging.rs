...
pub fn write_raw_log(
    ...
    if !payload.has_real_metrics {
        ...
        writeln!(
            file,
            "next_action=replace src/graph_core/src/payload/{}.rs with a real DiskANN adapter before using this file as an experiment result",
...
pub fn append_manifest(
    ...
    writeln!(
        file,
        "02_diskann_fair,{},{},{},adapter_slot,src/graph_core,{},{},{},4,{},{},\"{}\"",
        ctx.dataset.name,
        payload.method,
        payload.status,
