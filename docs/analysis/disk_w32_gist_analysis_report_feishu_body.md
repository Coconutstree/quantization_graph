...
![Figure 1. 构建耗时精细化](@./docs/analysis/fig01_build_export_cost_w32_gist.png)
...
![Figure 2. 05C Recall/QPS/I-O 曲线](@./docs/analysis/fig02_w32_recall_qps_io_curves_gist.png)

图读法：只看 05C system 层。左图是 Recall@10 与 QPS 的 trade-off；右图是达到相同 recall 时需要付出的 I/O requests/query。

### Figure 3：Ours-Disk 查询时间拆分

![Figure 3. Ours-Disk 查询时间拆分](@./docs/analysis/fig03_ours_query_time_decomposition_w32_gist.png)
