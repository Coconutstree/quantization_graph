...
![Figure 2. AGNews 05C Recall/QPS/I-O 曲线](fig02_w32_recall_qps_io_curves_agnews.png)

图读法：只看 05C system 层。左图是 Recall@10 与 QPS；右图是达到相同 recall 时的 I/O requests/query。

### Figure 3：Ours-Disk 查询时间拆分

![Figure 3. AGNews Ours-Disk 查询时间拆分](fig03_ours_query_time_decomposition_w32_agnews.png)
