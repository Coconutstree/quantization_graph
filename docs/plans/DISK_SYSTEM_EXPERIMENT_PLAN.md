...
> 2026-09-16 更新：05C 主方法改为 Ours、DiskANN、AiSAQ、Starling。当前有效的 05C 方法、存储策略、调参与内存核算规定见 [OFFICIAL_DISK_BASELINES.md](OFFICIAL_DISK_BASELINES.md)。下文旧五方法与强制统一驻留/图参数条款仅保留作历史移植方案，不能用于新 05C 主实验。05A/05B 不变。
